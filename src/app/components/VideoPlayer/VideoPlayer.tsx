...
const VideoPlayer = () => {
  ...
  return (
    ...
    >
      ...
      {/* High res video: https://firebasestorage.googleapis.com/v0/b/digital-rilievi.appspot.com/o/intro_high.mp4?alt=media&token=e3cd38b5-9503-4c87-9538-20b5a0ead246 */}
      {/* Low res video: https://firebasestorage.googleapis.com/v0/b/digital-rilievi.appspot.com/o/intro.mp4?alt=media&token=81ec90f8-2b53-403b-b445-8c9901f41f75 */}
